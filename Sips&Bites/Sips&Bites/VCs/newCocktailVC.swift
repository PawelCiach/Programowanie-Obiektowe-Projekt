...
class newCocktailVC: UIViewController, UITextFieldDelegate, UICollectionViewDelegate, UICollectionViewDataSource,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,UITextViewDelegate{
    
    //MARK: - outlets and actions
    
    
    @IBAction func addCocktailTapped(_ sender: Any) {
        print(self.metoda.text!)
        let nowyCocktail=Cocktail(context: context)
        nowyCocktail.iloscSkladnikow=ilosciSkl
        for skladnik in skladnikiAkt{
            nowyCocktail.addToSkladniki(skladnik)
            skladnik.addToCocktail(nowyCocktail)
        }
        nowyCocktail.nazwaPrzepisu=nazwaDania.text
        ...
        performSegue(withIdentifier: "backToCocktailVC", sender: self)
    }
    ...
    @IBAction func cocktailAddButtonTapped(_ sender: Any) {
        showAlert()
    }
...
extension newCocktailVC:UICollectionViewDelegateFlowLayout{
